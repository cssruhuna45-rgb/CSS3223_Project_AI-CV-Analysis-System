...
# Load ai-service/.env explicitly so it works regardless of the current
...
if not os.getenv("GEMINI_API_KEY"):
    print(
        f"[Startup] WARNING: GEMINI_API_KEY not set. "
        f"Looked for env file at: {_ENV_PATH} (exists={_ENV_PATH.exists()})"
    )
